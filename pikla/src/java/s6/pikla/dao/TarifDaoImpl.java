...
public class TarifDaoImpl implements TarifDao {
    ...
    public TarifDaoImpl(DAOFactory daoFactory) {
        this.daoFactory = daoFactory;
    }

    @Override
    public void save(Tarif person) throws Exception {
    ...
    @Override
    public void update(Tarif person) throws Exception {
        Connection connexion = null;
        PreparedStatement preparedStatement = null;
        try {
            connexion = daoFactory.getConnection();
    ...
    @Override
    public void delete(Tarif person) throws Exception {
        Connection connexion = null;
        PreparedStatement preparedStatement = null;
        try {
            connexion = daoFactory.getConnection();
    ...
    @Override
    public List<Tarif> findAll() throws Exception {
        Connection connexion = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        ArrayList<Tarif> tab = new ArrayList<>();
        try {
            connexion = daoFactory.getConnection();
    ...
    @Override
    public Tarif findByid(int id) throws Exception {
        Connection connexion = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        Tarif tab = new Tarif();
    ...
    private static Tarif map(ResultSet resultSet) throws SQLException {
        Tarif utilisateur = new Tarif();
        utilisateur.setIdTarif(resultSet.getLong(""));
        utilisateur.setTypeTarif(resultSet.getString(""));
        utilisateur.setPrixTarifHeure(resultSet.getInt(""));
        return utilisateur;
    }
}
